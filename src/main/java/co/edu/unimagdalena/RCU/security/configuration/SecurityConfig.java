package co.edu.unimagdalena.RCU.security.configuration;
...
import co.edu.unimagdalena.RCU.security.jwt.JwtAuthenticationFilter;
import co.edu.unimagdalena.RCU.security.error.Http401EntryPoint;  
import co.edu.unimagdalena.RCU.security.error.Http403AccessDenied;
        ...
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/api/patients", "/api/patients/{id}", "/api/doctors", "/api/doctors/{id}",
                                ...
                                "/api/availability/doctors/{doctorId}/appointment-types/{appointmentTypeId}").hasAnyRole("ADMIN", "USER", "RECEPTIONIST")
                .requestMatchers(HttpMethod.PATCH, "/api/appointments/{id}/confirm", "/api/appointments/{id}/cancel").hasAnyRole("ADMIN", "RECEPTIONIST")
                ...
                .requestMatchers(HttpMethod.POST, "/api/appointments").hasAnyRole("ADMIN", "USER", "RECEPTIONIST")
