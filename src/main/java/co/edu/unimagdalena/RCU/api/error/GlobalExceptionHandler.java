package co.edu.unimagdalena.RCU.api.error;
...
import co.edu.unimagdalena.RCU.exceptions.ValidationException;
...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<ApiError> handleValidationException(ValidationException exception, WebRequest request) {
		var body = ApiError.of(HttpStatus.UNPROCESSABLE_CONTENT, exception.getMessage(), request.getDescription(false),
	...
	public ResponseEntity<ApiError> handleBusinessException(BusinessException exception, WebRequest request) {
		var body = ApiError.of(HttpStatus.BAD_REQUEST, exception.getMessage(), request.getDescription(false),
				List.of());
	...
	public ResponseEntity<ApiError> handleGeneric(Exception ex, WebRequest req) {
		var body = ApiError.of(HttpStatus.INTERNAL_SERVER_ERROR, ex.getMessage(), req.getDescription(false),
				List.of());
